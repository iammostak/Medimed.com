...
<Box  w="100%" bg="white" p="2%" display={["unset","unset","none","none","none"]} >
            ...
            >
              ...
              <Flex  gap={"10px"}  w="100%" >
                ...
                {/* </Flex> */}
                <Flex justifyContent={"center"} alignItems={"center"} bg={"rgb(246,246,247)"}  minH={["25px"]} fontSize={"10px"} >Personal Care</Flex>
...
/>
  ...
  <Flex
    ...
    lineHeight={1}
  >
    <Text fontSize={["12px","12px","15px","20px","20px"]} >Check Availability</Text><br /> 
    <Flex onChange={(e)=>setPintext(e.target.value)} borderBottom="5px solid rgb(36,174,177)" justifyContent={"space-between"} alignItems="center" gap="2px"  >
      <Text fontSize={["15px","15px","20px","25px","25px"]} color={"rgb(36,174,177)"}>
        PINCODE:
      </Text>
      <Input type={"number"} placeholder="enter pin" color="rgb(36,174,177)" fontSize={["12px","12px","15px","20px","20px"]} border={"none"} variant='unstyled' />
      ...
      {pincheck?<Text fontWeight={"bold"}  >Expected Delivery {day+"-"+month+"-"+year}
