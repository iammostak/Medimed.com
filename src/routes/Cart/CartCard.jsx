        ...
        <Box borderBottom="1px solid gray">
            {data!== undefined && <Grid templateColumns='repeat(7, 1fr)'>
                ...
                <GridItem padding={2} colSpan={3}>
                    <Flex flexDirection={["column","column","row","row","row"]} gap={2} h="full" alignItems="flex-end">
                            ...
                            <Center fontSize={[10,10,20,20,20]} fontWeight="bold" w={10}>{data.quantity}</Center>

                            <Button fontSize={[10,10,15,15,18]}
                            onClick={()=>handleQty({id:data.productId,type:"inc"})} 
                            >+</Button>
                    
                            <Button onClick={()=>removeCartHandler(_id)} bg={"red"} color="white" fontSize={[10,10,15,15,18]}
